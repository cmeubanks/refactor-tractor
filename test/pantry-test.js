...
describe('Pantry', function() {
      ...
      it.skip('should be an instance of Pantry class', function() {
        let pantry = new Pantry(ingredientsData);

        expect(pantry).to.be.an.instanceOf(Pantry);
      });

      it.skip('should be able to show all ingredients', function() {
        let pantry = new Pantry(ingredientsData);
      ...
      it.only('should be able to find a recipe', function() {
        ...
        it.skip('should be able to tell what ingredients are missing for a recipe', function() {
          ...
          expect(pantry.checkStillNeeded('Loaded Chocolate Chip Pudding Cookie Cups')).deep.equal([{
            "id": 2050,
